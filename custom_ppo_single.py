    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, num_steps):
            ...
            for item in info:
                if "episode" in item.keys():
                    ...
                    rewards_record.append(item["episode"]["r"])
                    lengths_record.append(item["episode"]["l"])
                    ...
                    writer.add_scalar("charts/min_length", min(lengths_record[-1 * min(100, len(lengths_record)):]), global_step)
                    writer.add_scalar("charts/max_length", max(lengths_record[-1 * min(100, len(lengths_record)):]), global_step)
                    break
        ...
        for epoch in range(update_epochs):
            ...
            for start in range(0, batch_size, minibatch_size):
                ...
                print(b_obs.shape, b_actions.shape)
